...
- No connection to Arduino, how can i fix that?
  ...
  and your software worked before, continue reading with 3. 
  ...
  reading, otherwise resolder those joints. Try again and have a look to the logs. If the error still occurs continue reading with 2.
    
  2.
  
  3. Check your fabscanpi-server version. It should be 0.4.2 or higher. 
